...
define(['angularAMD',
    ...
    function (angularAMD) {
        ...
        app.run(['$rootScope', '$http', '$resource', '$state', 'deviceDetection', function ($rootScope, $http, $resource, $state, deviceDetection) {
            ...
            $rootScope.device = deviceDetection.deviceTitle();
        ...
        app.config([
            ...
            function (routeResolverProvider, $stateProvider, $urlRouterProvider, $httpProvider) {
                ...
                $stateProvider
                    ...
                    .state('register', route.resolve('/register/:id', 'views/homepage/index'))
        ...
        app.factory('user', ['$http', '$rootScope', '$resource', 'UknackModals', 'restricted',
            function($http, $rootScope, $resource, UknackModals, restricted) {
                $rootScope.restricted();
                ...
                function connect(user_to_connect) {
                    if($rootScope.is_authenticated) {
                        ...
                        UknackModals.openLoginModal('You need to login to be able to connect with other classmates.');
                    }
                }
